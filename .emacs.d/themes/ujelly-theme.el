...
(let ((class '((class color) (min-colors 89)))
      ...
      (custom-theme-set-faces
       ...
       `(iedit-occurrence ((,class (:foreground ,"color-255"))))
       `(isearch ((,class (:background ,"color-238"))))
       ...
       `(ivy-minibuffer-match-face-1 ((,class (:foreground ,ujelly-blue-0))))
       `(ivy-minibuffer-match-face-2 ((,class (:foreground ,ujelly-blue-0))))
       `(ivy-minibuffer-match-face-3 ((,class (:foreground ,ujelly-blue-0))))
       `(ivy-minibuffer-match-face-4 ((,class (:foreground ,ujelly-blue-0))))
       `(lazy-highlight ((,class (:foreground ,"color-160", :background ,nil))))
