  ...
  in {
    ...
    programs.niri.settings = {
      ...
      binds = {
        ...
        "Mod+Shift+7".action.focus-workspace = 1;
        "Mod+BracketLeft".action.focus-workspace = 2;
        "Mod+Shift+BracketLeft".action.focus-workspace = 3;
        "Mod+Shift+BracketRight".action.focus-workspace = 4;
        "Mod+Shift+9".action.focus-workspace = 5;
        # "Mod+6".action.focus-workspace = 6;
        # "Mod+7".action.focus-workspace = 7;
        # "Mod+8".action.focus-workspace = 8;
        # "Mod+9".action.focus-workspace = 9;
        "Mod+Ctrl+Shift+7".action.move-column-to-workspace = 1;
        "Mod+Ctrl+BracketLeft".action.move-column-to-workspace = 2;
        "Mod+Ctrl+Shift+BracketLeft".action.move-column-to-workspace = 3;
        "Mod+Ctrl+Shift+BracketRight".action.move-column-to-workspace = 4;
        "Mod+Ctrl+Shift+9".action.move-column-to-workspace = 5;
